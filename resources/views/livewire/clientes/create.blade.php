...
new class extends Component {
    ...
    public function mount(array $cliente): void
    {
        ...
        $this->usercode = $cliente["codigo_cliente"];
        $this->name = $cliente["nome_fantasia"];
    }
...
<div>
    <x-button icon="o-users" @click="$wire.createUserModal = true" class="btn-ghost btn-sm text-indigo-500"
        tooltip="Criar conta para o cliente" />
