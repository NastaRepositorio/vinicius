    ...
    <x-card>
        <div class="md:grid-cols-3 grid grid-cols-1 gap-4">
            ...
            <x-stat 
                ...
                value="{{ $contasReceberAbertasCount }}" 
                icon="o-exclamation-triangle"
                description="{{ $contasReceberAbertasValueFormatted }}"
                color="text-yellow-500" 
            />

            <x-stat 
                title="Contas Atrasadas" 
                value="{{ $contasReceberAtrasadasCount }}" 
                icon="o-exclamation-circle"
                description="{{ $contasReceberAtrasadasValueFormatted }}"
                color="text-red-500" 
            />

            <x-stat 
                title="Contas Pagas" 
                value="{{ $contasReceberPagasCount }}" 
                icon="o-check-circle"
                description="{{ $contasReceberPagasValueFormatted }}"
